...
public class FrontCameraActivity extends AppCompatActivity {
    ...
    private static final String STREAM_URL = "http://192.168.137.127:5000/video"; // Replace with your stream URL
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reverseButton.setOnClickListener(v -> {
            Intent intent = new Intent(FrontCameraActivity.this, MainActivity.class);
